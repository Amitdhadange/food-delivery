...
const Food = (props) => {
  ...
  return (
    <div className=" mt-10">
      ...
      <div className="flex flex-col bg-gray-100 border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.9]">
  <img className="w-full h-60 rounded-lg" src={props.foodItems.img} alt="Image Description"/>
